...
export interface CheckOutPopupProps
    extends Omit<
        ...
        'children' | 'onClickButton' | 'labelButton' | 'isOpen' | 'onClose'
    > {
    readonly onClickButton: (typePayment: PaymentTypes) => void;
...
export const CheckOutPopup = injectable(
                                    ...
                                    onChenge={(e) =>
                                        updateFormData({
                                            comment: {
                                                data: e,
                                                isValid:
                                                    formData.comment.isValid,
                                            },
                                        })
                                    }
                                />
                                <CheckBox
                                    getCheckedState={(x) => setCheckboxState(x)}
                                >
                                    <span>
                                        I have read the{' '}
                                        <span
